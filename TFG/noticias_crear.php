        ...
        if (isset($_POST['Insertar'])) {
            ...
            if (empty($titulo) || empty($contenido) || empty($imagen) || empty($prioridad)) {
                ...
                if (!in_array($prioridad, $prioridades_permitidas)) {
                    ...
                    $consulta = "INSERT INTO Noticias (titulo, contenido, imagen, prioridad) 
                                 VALUES ('$titulo', '$contenido', '$imagen', '$prioridad')";
                    ...
                    if (mysqli_query($cnx, $consulta)) {
                        ...
                        echo "<div class='alert alert-danger text-center'><strong>Error al insertar la noticia.</strong></div>";
                    }
                }
            }
