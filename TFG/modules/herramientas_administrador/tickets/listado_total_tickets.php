...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item"><a class="nav-link" href="gestion_tickets.php">Mis Solicitudes</a></li>
...
$consulta = "SELECT tickets.*, usuarios.nombre AS nombre_usuario 
             ...
             ORDER BY   tickets.estado,   tickets.prioridad , tickets.fecha_actualizacion  DESC";
...
<div class="container mt-4">
    <h1 class="text-center">Listado tickets</h1>
